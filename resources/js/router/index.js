...
const routes = [
    ...
    {path: '/analytic/shopify', name: 'ShopifyStyleOverview', component: ShopifyStyleOverview,},
    {path: '/analytic/traffic', name: 'AnalyticsTraffic', component: AnalyticsTraffic,},
    {path:'/analytic/orders',name:"AnalyticsOrders",component:AnalyticsOrders},
    {path:'/analytic/sales',name:"SalesAnalytics",component:SalesAnalytics},
    {path:'/analytic/sessions',name:"SessionsAnalytics",component:SessionsAnalytics},
    {path:'/analytic/products',name:"ReferrerProductAnalytics",component:ReferrerProductAnalytics},
    {path:'/analytic/live-view',name:"LiveViewPage",component:LiveViewPage},
