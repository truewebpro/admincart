...
import BlogSliderPreview from "@/components/previews/BlogSliderPreview.vue";
...
import ReviewSliderPreview from "@/components/previews/ReviewSliderPreview.vue";
...
export default {
    ...
    methods:{
        ...
        addSection(){
            ...
            const sdata = {
                homepage_id:this.hlayout.homepage_id,
