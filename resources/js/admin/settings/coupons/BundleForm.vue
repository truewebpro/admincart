        ...
        <v-row dense>
            <v-col cols="12" md="6">
                <v-text-field variant="outlined" density="compact"
                              v-model="coupon.title" placeholder="product 3 for 12"
            ...
            <v-col cols="12" md="6">
                <v-text-field variant="outlined" density="compact"
                              v-model="coupon.display_title" placeholder="3 for £12"
            ...
            <v-col cols="6">
                <v-number-input variant="outlined" density="compact"
                                v-model="coupon.bundle_qty" label="Bundle Qty"/>
            </v-col>
            <v-col cols="6">
                <v-number-input variant="outlined" density="compact" :precision="2"
                                v-model="coupon.bundle_price" label="Bundle Price"/>
            </v-col>
            <v-col cols="12" md="6">
                <!-- Applies To -->
