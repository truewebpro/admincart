            ...
            <v-card>
                ...
                <v-card-text>
                    <v-text-field variant="outlined" density="compact" persistentPlaceholder
                                  placeholder="Question about the brand"
...
export default {
    ...
    methods:{
        ...
        async addFaq() {
            ...
            await axios.post(`/sadmin/brand/add-faq`,adata)
                .then((resp)=>{
        ...
        updateFaq(){
            ...
            axios.post(`/sadmin/brand/edit-faq`,edata)
                .then((resp)=>{
                    this.$emit('refresh-faqs');
        ...
        deleteFaq(){
            ...
            axios.post(`/sadmin/brand/delete-faq`,ddata)
                .then((resp)=>{
                    this.$emit('refresh-faqs');
