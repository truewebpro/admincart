<template>
    <div class="brandsections">
        <div class="homepage d-flex flex-column ga-4">
            <div v-for="(section,sindex) in sections" :key="sindex" :class="section.section_status+ ' ' +'brandsections section_'+section.section_json.stype_slug">
                <component
...
export default {
    ...
    methods:{
        addSection(){
            ...
            axios.post('/sadmin/brand/section/add/new',sdata)
                .then((resp)=>{
                    this.$emit('refresh');
...
.hide.brandsections > .v-card {opacity: 0.4}
.ebuttons {
    margin: 8px auto;
}
</style>
