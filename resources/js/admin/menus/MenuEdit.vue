<template>
    <div>
        <v-form v-model="muvalid" @submit.prevent="saveMenu">
            <v-container>
                    ...
                    <v-col cols="12" md="6" class="text-end">
                        ...
                        <v-menu>
                            ...
                            <v-list nav density="compact">
                                <v-list-item base-color="error" @click="perdeleteMenu">
                                    <v-list-item-title><v-icon class="me-2">mdi-trash-can-outline</v-icon>Delete Menu</v-list-item-title>
                                </v-list-item>
                            </v-list>
                        </v-menu>
                    </v-col>
                ...
                <v-row justify="center">
                    <v-col cols="12" md="9">
                        <v-card class="border-sm">
                            <v-card-text>
                                <v-text-field v-model="menu.menu_name" label="Name" placeholder="Sidebar menu"
                    ...
                    <v-col cols="12" md="9">
                        <v-card class="border-sm">
                            ...
                            <v-card-text>
                                <v-list ref="menuList" density="comfortable" class="my-2">
                                    <RecursiveMenu
                                        :items="menuItems"
                                        :level="0"
...
export default {
    ...
    computed:{
        ...
        formErrors(){
            const errors = {};
            if(!this.muvalid){errors.form = "Label is Missing";}
    ...
    methods:{
        ...
        getMenuById(){
           axios.get('/sadmin/menu/edit/'+this.menu_id)
               .then((resp)=>{
        ...
        saveMenu(){
            ...
            axios.post('/sadmin/menu/update',transformed,uheaders)
                .then((resp)=>{
        ...
        perdeleteMenu(){
            ...
            axios.post('/sadmin/menu/delete',pdelete,uheaders)
                .then((resp)=>{
                    window.Toast.success(resp.data.message);
