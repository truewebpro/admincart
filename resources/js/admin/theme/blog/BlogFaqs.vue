            ...
            <v-card>
                ...
                <v-card-text>
                    <v-text-field variant="outlined" density="compact" persistentPlaceholder
                                  placeholder="Question about the blog"
...
export default {
    ...
    methods:{
        ...
        async addFaq() {
            ...
            await axios.post(`/sadmin/blog/add-faq`,adata)
                .then((resp)=>{
        ...
        updateFaq(){
            ...
            axios.post(`/sadmin/blog/edit-faq`,edata)
                .then((resp)=>{
                    this.$emit('refresh-faqs');
        ...
        deleteFaq(){
            ...
            axios.post(`/sadmin/blog/delete-faq`,ddata)
                .then((resp)=>{
                    this.$emit('refresh-faqs');
