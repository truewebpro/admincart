<template>
    <div class="catsections">
        <div class="homepage d-flex flex-column ga-4">
            <div v-for="(section,sindex) in sections" :key="sindex" :class="section.section_status+ ' ' +'catsections section_'+section.section_json.stype_slug">
                <component
...
.hide.catsections > .v-card {opacity: 0.4}
.ebuttons {
    margin: 8px auto;
}
</style>
